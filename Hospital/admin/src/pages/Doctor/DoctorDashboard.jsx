...
const DoctorDashboard = () => {
    ...
    const { dashboardData, setDashboardData, getDashboardData, dToken, completeAppointment, cancelAppointment } = useContext(DoctorContext)
    ...
    <div className='m-5'>
        ...
        <div className='bg-white'>
            ...
            <div className='pt-4 border border-t-0'>
                {
                    dashboardData.latestAppointments.map((items, index) => (
